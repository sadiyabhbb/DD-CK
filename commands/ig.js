...
module.exports.run = async (bot, msg) => {
    ...
    // Note: If you want to use the "/" alias, you must remove the "/" from your global aliases in config.js
    // or change the alias name here to avoid conflict with other commands.
    ...
    try {
      ...
      bot.sendMessage(chatId, "❌ An error occurred while fetching content. Please try again later.", { reply_to_message_id: messageId });
    }
};
